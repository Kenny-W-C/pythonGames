...
AST_VEL_SCALE = 1.8  # How much asteroid speed multiplies when broken up
...
class AsteroidsDemo(ShowBase):
    ...
    def updateShip(self, dt):
        ...
        if self.keys["accel"]:
            ...
            newVel = \
                LVector3(sin(heading_rad), 0,
                         cos(heading_rad)) * ACCELERATION * dt
